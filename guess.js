...
while (isNaN(intGuess) || (intGuess < intMin || intGuess > intMax)) // guess must be a number and be between the max and min numbers
{
    intGuess = parseInt(prompt("Invalid number. Please enter your guess (must be between " + intMin + " and " + intMax + ")")); // validates user's guess
}
...
{
    intGuess = parseInt(prompt("Error! Please enter your guess (must be between " + intMin + " and " + intMax + ")")); // validates user input
} 
}
